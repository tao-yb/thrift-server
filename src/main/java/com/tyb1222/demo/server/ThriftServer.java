package com.tyb1222.demo.server;

import com.tyb1222.demo.service.impl.MyServerServiceImpl;
...
public class ThriftServer {
    ...
    public void start() {
        try {
            ...
            //泛型就是实现的业务
            PersonService.Processor<MyServerServiceImpl> processor = new PersonService.Processor<>(myServerService);
